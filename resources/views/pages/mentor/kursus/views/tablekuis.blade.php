    ...
    <tbody>
        @foreach ($data as $key => $dat)
            <tr>
                ...
                <td><a href="{{ route('mentor.kursus.views.sub-menu-tema.content.edit', [$id, base64_encode($dat->id_kuis)]) }}"
                        class="btn btn-block btn-success btn-sm">Edit</a>
                    <a href="{{ route('mentor.kursus.views.kuis.soal', [base64_encode($dat->id_kuis)]) }}"
