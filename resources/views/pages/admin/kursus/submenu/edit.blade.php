            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('kursus.menu.update', [$ido]) }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="judul" value="{{ $edit->judul_sub_menu_kursus }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="status_sub_menu_kursus" class="form-control form-control-lg @error('status_sub_menu_kursus') is-invalid @enderror">
